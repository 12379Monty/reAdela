---
title:  "Quantification and Differential Methylation Analysis - Enrichment-Based Assays"
...
bibliography: [_Enrichment_methods_references.bib]
...
**Reference:** Down et al. (2008) [@Down2008] *Nature Biotechnology* 26:779-785
...
**Reference:** Lienhard et al. (2014) [@Lienhard2014] *Bioinformatics* 30:284-286; 
Chavez et al. (2010) [@Chavez2010] *Genome Research* 20:1441-1450

###  Method Overview

MEDIPS is an R/Bioconductor package for genome-wide differential coverage analysis of MeDIP-seq data. It provides quality control metrics, normalization based on CpG coupling analysis, and differential methylation detection using edgeR's negative binomial framework [@Robinson2010].
...
**Reference:** Lienhard et al. (2017) [@Lienhard2017] *Nucleic Acids Research* 45:e44
...
**Reference:** Xu et al. (2018) [@Xu2018] *BMC Bioinformatics* 19:574
...
**Reference:** Zhu et al. (2023) [@Zhu2023] *Bioinformatics* 39:btad423
...
**Reference:** Friedman et al. (2010) [@Friedman2010] *Journal of Statistical Software* 33:1-22
...
- $0 < \alpha < 1$: Elastic net (combination)bb
...
**Reference:** Ding & Bar-Joseph (2017) [@Ding2017] *Bioinformatics* 33:3477-3479
