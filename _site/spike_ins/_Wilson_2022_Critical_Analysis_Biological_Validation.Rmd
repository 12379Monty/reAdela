---
title: A Critical Evaluation of Wilson et al. (2022)
...
**Document Purpose:** This analysis critically evaluates whether Wilson et al. (2022) [@Wilson:2022aa] demonstrates that spike-in normalization improves the analysis of biological (non-spike-in) DNA fragments compared to standard normalization methods.
...
Wilson et al. (2022) [@Wilson:2022aa] provides **compelling evidence** for technical improvements (absolute quantification, batch effect reduction, technical reproducibility) but provides **minimal direct evidence** that spike-in normalization improves biological analysis outcomes compared to standard normalization methods.
...
## Evidence Presented in Wilson et al. (2022)

###  Figure 4: Correlation with EPIC Array (HCT116 Cell Line)
...
###  Figure 6: Principal Component Analysis of Multi-Lab AML Samples
...
###  Table S6: Sample-Sample Correlations (Technical Replicates)
...
###  Direct Biological Validation Experiments
...
1. **Reanalysis of Shen et al. (2018) [@Shen2018] Data:**
...
###  Optimistic Interpretation (Authors' View)
...
## Implications for Platform Comparisons

###  Adela vs. GRAIL: Spike-ins as Differentiator?
...
###  Unanswered Questions for Platform Comparison
...
## Where Would Biological Validation Evidence Be Found?

###  Subsequent Publications by Adela/De Carvalho Lab
...
###  Publications by Independent Groups Using spiky
...
## Critical Evaluation of Study Design Choices

###  Choice of HCT116 for Biological Validation
...
###  Choice of AML for Multi-Lab Study
...
##  Comparison to Other Methodological Advances
...
###  Lessons from Methodological History
...
###  Experiments That Would Provide Definitive Evidence
...
##  Alternative Explanations for Adela's Platform Performance

###  If Adela's MCED/MRD Shows Strong Performance
...
###  If Adela's Performance is Similar to GRAIL
...
###  Recommendations for Adela vs. GRAIL Comparison
...
<!-- To run
## up Rscript -e "knitr::knit2html('_Wilson_2022_Critical_Analysis_Biological_Validation.Rmd')" > _Wilson_2022_Critical_Analysis_Biological_Validation.log  &

## Or
## up Rscript -e "rmarkdown::render('_Wilson_2022_Critical_Analysis_Biological_Validation.Rmd')" > _Wilson_2022_Critical_Analysis_Biological_Validation.log  &
