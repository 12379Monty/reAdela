...
## Report 1.4 Sources of variability {-}
...
## Repor 1.5 Variability Mitigation {-}
...
* We need to gather the empirical evidence that the extra variability
...
<p><p/>
*  More than one model should be examined
   - helps distinguish between model failure (only one model fails
at given sample point) and sample failure (all models fail)

<p><p/>
* more detailed examination of results
   - which samples are mis-classified?
   - do all models miss the same samples?
   - bias vs variance
