--- 
title:  "Differential Methylation Analysis Methods"
...
bibliography: [_Differential_methylation_references.bib]
...
FN <- "_Differential_Methylation_Analysis_Report"
...
(1) a detailed catalog of analytical methods with publication highlights, 
(2) an examination of the input data structures that distinguish each platform, and 
(3) a review of benchmark studies that have evaluated method performance head-to-head.

---

# PART I: Differential Methylation Analysis Methods

## Enrichment-Based Methods (MeDIP-seq / cfMeDIP-seq)
...
**Publication:** Down TA et al. A Bayesian deconvolution strategy for immunoprecipitation-based DNA methylome analysis. *Nature Biotechnology* 2008;26(7):779-785. [@Down2008]
...
### MEDIPS (Methylated DNA Immunoprecipitation Sequencing)

**Publication:** Lienhard M et al. MEDIPS: genome-wide differential coverage analysis of sequencing data derived from DNA enrichment experiments. *Bioinformatics* 2014;30(2):284-286. [@Lienhard2014]
...
### QSEA (Quantitative Sequence Enrichment Analysis)

**Publication:** Lienhard M et al. QSEA—modelling of genome-wide DNA methylation from sequencing enrichment experiments. *Nucleic Acids Research* 2017;45(6):e44. [@Lienhard2017]
...
**Publication:** Xu J et al. MeDEStrand: an improved method to infer genome-wide absolute methylation levels from DNA enrichment data. *BMC Bioinformatics* 2018;19:540. [@Xu2018]
...
**Publication:** Zeng Y et al. MEDIPIPE: an automated and comprehensive pipeline for cfMeDIP-seq data quality control and analysis. *Bioinformatics* 2023;39(7):btad423. [@Zeng2023]
...
### GLMnet-Based Classification (cfMeDIP-seq Cancer Detection)

**Publication:** Shen SY et al. Sensitive tumour detection and classification using plasma cell-free DNA methylomes. *Nature* 2018;563(7732):579-583. [@Shen2018]
...
### Alternative Classification Approaches for cfMeDIP-seq
...
**Publication:** Ding J & Bar-Joseph Z. MethRaFo: MeDIP-seq methylation estimate using a Random Forest Regressor. *Bioinformatics* 2017;33(21):3477-3479. [@Ding2017]
...
## Bisulfite Sequencing Methods (WGBS / RRBS)
...
**Publication:** Feng H et al. A Bayesian hierarchical model to detect differentially methylated loci from single nucleotide resolution sequencing data. *Nucleic Acids Research* 2014;42(8):e69. [@Feng2014]
...
**Publication:** Akalin A et al. methylKit: a comprehensive R package for the analysis of genome-wide DNA methylation profiles. *Genome Biology* 2012;13:R87. [@Akalin2012]
...
**Publication:** Hansen KD et al. BSmooth: from whole genome bisulfite sequencing reads to differentially methylated regions. *Genome Biology* 2012;13:R83. [@Hansen2012]]
...
**Publication:** Hebestreit K et al. Detection of significantly differentially methylated regions in targeted bisulfite sequencing data. *Bioinformatics* 2013;29(13):1647-1653. [@Hebestreit2013]
...
**Publication:** Dolzhenko E & Smith AD. A beta-binomial mixture model for molecular count data. *Bioinformatics* 2014. [@Dolzhenko2014]
...
**Publication:** Sun D et al. MOABS: model based analysis of bisulfite sequencing data. *Genome Biology* 2014;15:R38. [@Sun2014]
...
**Publication:** Jühling F et al. metilene: fast and sensitive calling of differentially methylated regions from bisulfite sequencing data. *Genome Research* 2016;26(2):256-262. [@Juhling2016]
...
### HMM-Based Methods (HMM-DM and HMM-Fisher)

**Publication:** Yu X & Sun S. HMM-DM: identifying differentially methylated regions using a hidden Markov model. *Statistical Applications in Genetics and Molecular Biology* 2016;15(1):69-81. [@Yu2016]
...
**Publication:** Smyth GK. Linear models and empirical Bayes methods for assessing differential expression in microarray experiments. *Statistical Applications in Genetics and Molecular Biology* 2004;3:Article3. [@Smyth2004]
...
**Publication:** Peters TJ et al. De novo identification of differentially methylated regions in the human genome. *Epigenetics & Chromatin* 2015;8:6. [@Peters2015]
...
**Publication:** Jaffe AE et al. Bump hunting to identify differentially methylated regions in epigenetic epidemiology studies. *International Journal of Epidemiology* 2012;41(1):200-209. [@Jaffe2012]
...
**Publication:** Pedersen BS et al. Comb-p: software for combining, analyzing, grouping and correcting spatially correlated P-values. *Bioinformatics* 2012;28(22):2986-2988. [@Pedersen2012]
...
### missMethyl (GOmeth and GOregion)

**Publication:** Phipson B et al. missMethyl: an R package for analyzing data from Illumina's HumanMethylation450 platform. *Bioinformatics* 2016;32(2):286-288. [@Phipson2016]
...
**Publication:** Gomez L et al. coMethDMR: accurate identification of co-methylated and differentially methylated regions in epigenome-wide association studies with continuous phenotypes. *Nucleic Acids Research* 2019;47(17):e98.Q [@Gomez2019]
...
### QSEA Benchmark (Lienhard et al. 2017 [@Lienhard2017])
...
### MeDEStrand Benchmark (Xu et al. 2018 [@Xu2018])
...
### MethRaFo Benchmark (Ding & Bar-Joseph 2017 [@Ding2017])
...
### Comprehensive Evaluation (Park et al. 2021 [@Park2021])

**Publication:** Park Y et al. Comprehensive Evaluation of Differential Methylation Analysis Methods for Bisulfite Sequencing Data. *International Journal of Environmental Research and Public Health* 2021;18:7975. [@Park2021]
...
### Five-Method Comparison (Yu & Sun 2016 [@Yu2016])

**Publication:** Yu X & Sun S. Comparing five statistical methods of differential methylation identification using bisulfite sequencing data. *Statistical Applications in Genetics and Molecular Biology* 2016;15(1):69-81. [@Yu2016]
...
### Comprehensive Survey (Shafi et al. 2018 [@Shafi2018])

**Publication:** Shafi A et al. A survey of the approaches for identifying differential methylation using bisulfite sequencing data. *Briefings in Bioinformatics* 2018;19(5):737-753. [@Shafi2018]
...
### Strategies for Bisulfite Analysis (Akalin et al. 2012 [@Akalin2012])
...
### False Positive Rate Evaluation (Gatev E et al. 2022 [@Gatev2022])

**Publication:** Gatev E et al. An evaluation of the genome-wide false positive rates of common methods for identifying differentially methylated regions using Illumina methylation arrays. *Epigenetics* 2022. [@Gatev2022]
...
### DMRcate Benchmark (Peters et al. 2015 [@Peters2015])
...
### Microarray and NGS Quality Assessment ( Abramov S et al. 2023 [@Abramov2023])

**Publication:** Abramov S et al. Assessing the Differential Methylation Analysis Quality for Microarray and NGS Platforms. *International Journal of Molecular Sciences* 2023;24:8591. [@Abramov2023]
...
_Differential_Methylation_Analysis_Report.References.txt
...
<!-- To run
## nohup Rscript -e "knitr::knit2html('_Differential_Methylation_Analysis_Report.Rmd')" > _Differential_Methylation_Analysis_Report.log  &
    
## Or 
## nohup Rscript -e "rmarkdown::render('_Differential_Methylation_Analysis_Report.Rmd')" > _Differential_Methylation_Analysis_Report.log  &
