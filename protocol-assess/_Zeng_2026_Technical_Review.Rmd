---
title: Technical Review of Zeng et al. (2026) -  A Pan-Cancer Compendium of 1,294 Plasmas
subtitle: DNA Methylomes and Fragmentomes Enabling Multicancer Detection
...
* ** A negative correlation was observed between enrichment scores 
(GoGe and relH) and fragment size in PE profiles**
</span>

* , **indicating that longer fragments may result in lower cfMeDIP signal-to-noise ratios**.

* This is an important finding for normalization: fragment length affects not only IP efficiency (as Wilson et al. 2022 demonstrated) but also the overall enrichment quality metric used for QC gating.
   - ??
...
<!-- To run
 ...
 nohup Rscript -e "rmarkdown::render('_Zeng_2026_Technical_Review.Rmd')" > n _Zeng_2026_Technical_Review.log    &
