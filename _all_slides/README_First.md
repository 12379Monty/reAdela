S# Consolidated Slides folder

* Sources:

   - AI/_Adela_vs_GRAIL_MCED_Comparison_slides/_Adela_vs_GRAIL_MCED.html (custoZZ 
   - AI/_cfmedip-seq_protocol_pipeline_classifiers_slides/_cfMeDIP_Evolution.Rmd (=fein(
          \Csk
### 6. Sample Processing
...
- Disease-specific applications (brain, RCC, breast)_cfMeDIP_Evolution.Rmd- Computational tools (MEDIPIPE)
